...
class OrbitalMechVectors {
  ...
  drawOrbitCurveAndVectors(){
    ...
    if (this._showV){
      ...
      this._v1.applyQuaternion(this._quat);
      this._v1.add(this._origin);
      this._vVectorShaftMesh.matrix.compose(this._v0, this._q1, this._scale);
  ...
  _constructVectors(){
    ...
    const shaftRadius = this._vectorSize*0.008;
  ...
  _constructPlanets(){
    ...
    texture = new THREE.TextureLoader().load('/static/img/2k_sun.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[0] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_moon.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[1] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_mercury.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[2] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_venus_atmosphere.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[3] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_earth_daymap.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[4] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_mars.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[5] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_jupiter.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[6] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_saturn.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[7] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_uranus.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
    this._planetMeshArray[8] = new THREE.Mesh(geometry, material);
    texture = new THREE.TextureLoader().load('/static/img/2k_neptune.jpg');
    material = new THREE.MeshPhongMaterial({map: texture});
